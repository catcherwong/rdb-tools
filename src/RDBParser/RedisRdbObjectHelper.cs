...
namespace RDBParser
{
    public static class RedisRdbObjectHelper
    {
        public static bool IsInt(byte[] bytes, out long res)
        {
            ...
            {
                res = ConvertBytesToInteger(bytes);
                return true;
            }
        ...
        public static long ConvertBytesToInteger(byte[] bytes)
        {
        ...
        public static byte[] ConvertIntegerToBytes(long num)
        {
